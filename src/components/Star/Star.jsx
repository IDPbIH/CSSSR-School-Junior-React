...
const Star = ({ design }) => {
    switch (design) {
        ...
        default: return (
            <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M8.87331 4.74659L13.6666 5.15992L10.0333 8.31325L11.12 12.9999L6.99998 10.5133L2.87998 12.9999L3.97331 8.31325L0.333313 5.15992L5.12665 4.75325L6.99998 0.333252L8.87331 4.74659ZM6.99998 3.06659V9.26659L9.51331 10.7866L8.84665 7.93325L11.06 6.01325L8.13998 5.75992L6.99998 3.06659Z" fill="#323C48" />
            </svg>
        );
    }
}
